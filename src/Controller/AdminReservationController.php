...
class AdminReservationController extends AbstractController
{
    ...
    public function validReservation($id, LocataireRepository $locataire, MailerService $mailerService, UserPasswordEncoderInterface $encoder, GeneratePdf $GeneratePdf)
    {
        ...
        $user = new User();
        $attestationCaf = $bailLocataire = new documentLocataire ();
        ...
        $bailLocataire->setLocataire($locataire);
        $bailLocataire->setType('bail');
        $attestationCaf->setLocataire($locataire);
        $attestationCaf->setType('attestationCaf');

        $this->entityManager->persist($user);
        $this->entityManager->persist($locataire);
        $this->entityManager->persist($bailLocataire);
